...
// const arrayOfPromises = brusselsSprouts.map(async (sprout, i) => {
//   const instruction = await obtainInstruction('brusselsSprouts', i).catch(console.error) 
...
// we did this bottom one in class
